...
import { FileExplorer, type FileExplorerRef } from '@/ui/explorer/FileExplorer';
...
const SectionCard: React.FC<SectionProps> = ({
  ...
  return (
    ...
    >
        ...
        <div className={styles.titleGroup}>
          <span className={styles.mainIcon}>
            {isOpen ? (
              ...
              <img src={fillIcon} className={styles.mainIconSize} />
            )}
          </span>
      ...
      {isOpen && (
        <div
          className={`${styles.content} ${className ? styles.flexContent : ''}`}
        >
          {children ? (
            children
          ) : (
...
export const LeftSection: React.FC = () => {
  ...
  const handleAddClick = () => {
    // 2. Call the child method
    if (explorerRef.current) {
      explorerRef.current.triggerImport();
    }
  };
  return (
      ...
      <SectionCard
        ...
        rightActions={
          <button
            ...
            title="Import Folder"
          >
            <img src={AddSmallIcon} className={styles.addIconSize} />
          </button>
        }
      >
        {/* 3. Pass the Ref */}
        <FileExplorer ref={explorerRef} />
      </SectionCard>
        ...
        rightActions={
          <div className={styles.actionGroup}>
            <button className={styles.iconBtn} title="Add Page">
              <img src={AddSessionIcon} className={styles.addIconSize} />
            </button>
            <button className={styles.iconBtn} title="Delete">
              <img src={DeleteAllIcon} className={styles.addIconSize} />
            </button>
            <button className={styles.iconBtn} title="Menu">
              <img src={VerticalDotsIcon} className={styles.addIconSize} />
            </button>
