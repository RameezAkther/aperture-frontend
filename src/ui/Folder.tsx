...
import ProjectOptionsMenu, {
  type MenuAction,
} from '@/ui/subui/ProjectOptionsMenu'; // Import Menu
  ...
  return (
    <div className="folder-container">
      ...
      <div
        ...
        onClick={() => !isRenamingSelf && onToggle(item.id)}
              ...
              <div key={child.id}>
                {child.type === 'folder' ? (
                  <Folder
                    ...
                    // Pass Rename props recursively
                    renamingId={renamingId}
                    onRenameSubmit={onRenameSubmit}
                    onCancelRename={onCancelRename}
                    // Pass Menu props recursively (CRITICAL FIX)
                    ...
                    {isChildRenaming ? (
                      <div style={{ padding: '6px 16px' }}>
                        <RenameInput
                          ...
                          onSave={(val) => onRenameSubmit(child.id, val)}
                          onCancel={onCancelRename}
                        />
                      </div>
                    ) : (
                      <ProjectButton
                        ...
                        onMenuClick={(e) => onMenuClick(e, child)}
                        // RENDER MENU HERE (CRITICAL FIX)
                        menuComponent={
